    ...
    return (
        <div className='m-5 h-full overflow-y-scroll'>
            ...
            <div className='bg-blue-50 border border-blue-100 rounded-xl p-4 mb-6 text-sm text-blue-700'>
                ...
                <p>Each doctor can log in at <span className='font-mono font-bold'>http://localhost:5173/doctor-portal</span> using their email and the default password <span className='font-mono font-bold'>12345678</span>.</p>
            </div>
